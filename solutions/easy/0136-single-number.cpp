...
int main() {
  ...
  check({1, 2, 3, 1, 2}, 3,
        "1 ^ 2 == 3, so a sloppy fold could return 3 for the wrong reason");
  check({1, 2, 1, 2, 3}, 3,
        "same values, order that rules out the coincidence above");
  ...
  // ---
  {
    ...
    check(nums, -30000,
          "29999 elements, the largest array the constraints allow");
  }

...
void checkTree(const std::string &label, TreeNode *root, const std::vector<int> &expected)
{
    Solution sol;
...
void check(const std::vector<std::optional<int>> &level, const std::vector<int> &expected)
{

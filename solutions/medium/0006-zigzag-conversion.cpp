...
int main()
{
    ...
    check("ABCD", 3, "ABDC"); // 'D' lands on the diagonal, back in the middle row
    check("ABCDE", 3, "AEBDC");
    ...
    checkAgainstReference(cycling, 999);  // the last character starts the diagonal
